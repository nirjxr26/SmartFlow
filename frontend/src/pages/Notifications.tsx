...
export default function Notifications() {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/backend/notifications/notifications.php?userId=${userId}&filter=${filter}`, {
        headers: {
  ...
  const markAsRead = async (id: number) => {
    try {
      ...
      const response = await fetch('http://localhost:8000/backend/notifications/notifications.php', {
        method: 'POST',
        headers: {
